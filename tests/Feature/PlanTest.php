...
it('generates a unique slug from name', function (): void {
    ...
    $plan2 = Plan::create(['name' => 'Basic', 'price' => 500, 'signup_fee' => 0, 'currency' => 'USD', 'invoice_period' => 1, 'invoice_interval' => 'month']);
...
it('knows if it is free', function (): void {
    ...
    $paid = Plan::create(['name' => 'Paid', 'price' => 1000, 'signup_fee' => 0, 'currency' => 'USD', 'invoice_period' => 1, 'invoice_interval' => 'month']);
...
it('knows if it has a trial', function (): void {
    $withTrial = Plan::create(['name' => 'Trial', 'price' => 1000, 'signup_fee' => 0, 'currency' => 'USD', 'invoice_period' => 1, 'invoice_interval' => 'month', 'trial_period' => 14, 'trial_interval' => 'day']);
    $noTrial = Plan::create(['name' => 'No Trial', 'price' => 1000, 'signup_fee' => 0, 'currency' => 'USD', 'invoice_period' => 1, 'invoice_interval' => 'month']);
...
it('can be activated and deactivated', function (): void {
    $plan = Plan::create(['name' => 'Toggle', 'price' => 1000, 'signup_fee' => 0, 'currency' => 'USD', 'invoice_period' => 1, 'invoice_interval' => 'month']);
...
it('can have features', function (): void {
    $plan = Plan::create(['name' => 'Featured', 'price' => 1000, 'signup_fee' => 0, 'currency' => 'USD', 'invoice_period' => 1, 'invoice_interval' => 'month']);
...
it('cascades deletes to features and subscriptions', function (): void {
    $plan = Plan::create(['name' => 'Deletable', 'price' => 1000, 'signup_fee' => 0, 'currency' => 'USD', 'invoice_period' => 1, 'invoice_interval' => 'month']);
